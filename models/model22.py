"""
As model21.py, but larger latent space.
Samples and reconstructions looking good. Learning progresses for longer.
"""
import os
...
class Decoder(tf.keras.Model):
    def __init__(self, n_latent):
        ...
        self.base_size = [output_shape[0] // 2 ** 2, output_shape[1] // 2 ** 2, 63]
...
class Model22(Model, tf.keras.Model):
    def __init__(self):
    ...
    def save(self, fp):
        self.save_weights(f"{fp}_22")

    def load(self, fp):
        self.load_weights(f"{fp}_22")
...
if __name__ == "__main__":
    # PYTHONPATH=. CUDA_VISIBLE_DEVICES=1 nohup python -u models/model22.py > models/model22.log &
