"""
As model20.py, but with discretized logistic loss.
Tried running with beta = 20: helps!
"""
import os
...
class Model24(Model, tf.keras.Model):
    def __init__(self):
    ...
    def save(self, fp):
        self.save_weights(f"{fp}_24")

    def load(self, fp):
        self.load_weights(f"{fp}_24")
...
if __name__ == "__main__":
    # PYTHONPATH=. CUDA_VISIBLE_DEVICES=1 nohup python -u models/model24.py > models/model24.log &
