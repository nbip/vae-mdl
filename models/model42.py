    ...
    def __init__(self, n_latent):
        ...
        self.convs = tf.keras.Sequential(
            [
                ...
                ResidualBlock(16, 32, rezero=True),
                layers.Conv2D(
    ...
    def __init__(self, n_latent):
        ...
        self.deconvs = tf.keras.Sequential(
            [
                ...
                ResidualBlock(16, 64, rezero=True),
                layers.Conv2DTranspose(
...
class Model42(Model, tf.keras.Model):
    def __init__(self):
...
if __name__ == "__main__":
    # PYTHONPATH=. CUDA_VISIBLE_DEVICES=1 nohup python -u models/model42.py > models/model42.log &
