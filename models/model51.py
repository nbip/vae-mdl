"""
Reproduce model36, but more modular setup,
like model47.
...
class Model51(Model, tf.keras.Model):
    def __init__(self):
...
if __name__ == "__main__":
    # PYTHONPATH=. CUDA_VISIBLE_DEVICES=1 nohup python -u models/model51.py > models/model51.log &
    ...
    model.val_batch()
    model.val_batch()
    # TODO: random seed issue, when running on GPU we get nans after 100 iterations. Fix for now: two val_batches first. This is equivalent to a different random seed.
