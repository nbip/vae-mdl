"""
As model20.py, but with gated blocks architecture.
Doesn't seem to improve much compared to no gated blocks
"""
import os
...
class Model21(Model, tf.keras.Model):
    def __init__(self):
    ...
    def save(self, fp):
        self.save_weights(f"{fp}_21")

    def load(self, fp):
        self.load_weights(f"{fp}_21")
...
if __name__ == "__main__":
    # PYTHONPATH=. CUDA_VISIBLE_DEVICES=1 nohup python -u models/model21.py > models/model21.log &
