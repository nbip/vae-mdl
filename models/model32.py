...
Looks good, like Normal with tanh on logstd
"""
import os
...
class Model32(Model, tf.keras.Model):
    def __init__(self):
...
if __name__ == "__main__":
    # PYTHONPATH=. CUDA_VISIBLE_DEVICES=1 nohup python -u models/model32.py > models/model32.log &
